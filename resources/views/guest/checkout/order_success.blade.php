<x-app-layout>
    ...
    <div class="container mx-auto py-4">
        <div class="max-w-2xl mx-auto bg-white p-8 shadow-md rounded">
            ...
            <a href="{{ route('client.orders')}}"  class="inline-block bg-orange-500 text-white text-sm px-4 py-2 rounded transition duration-100 ease-in-out hover:bg-orange-600 mt-4">View order</a>
